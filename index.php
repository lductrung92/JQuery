...
combination with many widgets like jqxTree, jqxGrid, jqxListBox and etc."/>
    ...
    <script type="text/javascript" src="libraries/jqwidgets/jqxdata.js"></script> 
    ...
    <script type="text/javascript" src="libraries/jqwidgets/jqxmenu.js"></script>
    <script type="text/javascript" src="libraries/jqwidgets/jqxgrid.js"></script>
    <script type="text/javascript" src="libraries/jqwidgets/jqxgrid.columnsresize.js"></script> 
    <script type="text/javascript" src="libraries/jqwidgets/jqxlistbox.js"></script>
    <script type="text/javascript" src="libraries/jqwidgets/jqxdropdownlist.js"></script>
    <script type="text/javascript" src="libraries/jqwidgets/jqxdragdrop.js"></script>
    <script type="text/javascript" src="libraries/scripts/demos.js"></script>
   <style type="text/css">
        .draggable-demo-cart
        {
